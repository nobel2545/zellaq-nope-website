   ...
   <div>
      ...
      <div className="ml-10 flex-row">
        ...
        <div className="flex flex-col space-y-48">
          ...
          <div>
            <img className="w-[300px] absolute mt-20 p-10 cursor-pointer ${isObject2Clicked ? 'w-300' : 'w-350'}`}
            onClick={() => setIsObject2Clicked(!isObject2Clicked)" src="folder_gacha_hover.svg" />
            <div className="top-[330px] font-english text-black absolute left-[65px] p-10 text-white flex flex-col " >
          ...
          <div>
            <img className="w-[300px] absolute mt-20 p-10 cursor-pointer ${isObject2Clicked ? 'w-300' : 'w-350'}`}
            onClick={() => setIsObject2Clicked(!isObject2Clicked)" src="folder_gacha_hover.svg" />
            <div className="top-[480px] font-english text-black absolute left-[65px] p-10 text-white flex flex-col " >
             <h1 className="text-l"> Soul Pathfider: </h1>
             <h2 className="text-4xl"> Fire series </h2>
            </div>
          </div>
